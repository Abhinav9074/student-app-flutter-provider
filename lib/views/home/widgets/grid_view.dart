  ...
  Widget build(BuildContext context) {
    return GridView.count(
      ...
      children: List.generate(
          context.watch<ScreenProvider>().allStudentList.length, (index) {
        final data = context.watch<ScreenProvider>().allStudentList[index];
            ...
            child: Column(
              ...
              children: [
                ...
                ListTile(
                  leading: IconButton(
                    onPressed: () {
                      context.read<ScreenProvider>().updateImage(data.image);
